class Movie {
  ...
  factory Movie.fromJson(Map<String, dynamic> json) {
    return Movie(
      ...
      title: json['title'] ?? 'Título Desconocido', // Proporciona un valor por defecto si es nulo
      ...
      releaseDate: json['release_date'] ?? 'Fecha Desconocida', // Fecha de estreno, valor por defecto
    );
  }
}
